// check-matrices-equality.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	if (isMatricesEqual(matrix1,matrix2,3,3))
		cout << "Matrices are equales\n";
	else 		cout << "Matrices are not equales\n";
